...
''' </summary>
Module D12X0000
    Public ForDeveloping As Boolean = True
...
#End If
    ...
    Private Function CheckSecurity() As Boolean
        ...
        Else
            ...
            Dim FiVerInfo As FileVersionInfo = FileVersionInfo.GetVersionInfo(Application.StartupPath & "\" & MODULED12 & ".EXE")
...
#End If
    ...
    Private Sub GetAllParameter()
        ...
        PARA_TranMonth = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "TranMonth", "06")
        ...
        'PARA_FormState = CType(D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "Ctrl03", "0"), EnumFormState)

        PARA_gbClosed = CBool(D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "Closing", "False"))
        PARA_gbyUseWorkFlow = CByte(D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "UseWorkFlow", "0"))

        PARA_ID01 = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "ID01", "")
        PARA_PRID = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "ID03", "")
        PARA_FormIDParent = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "ID07", "")
        PARA_CreateBy = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "CreateBy", "")
        PARA_ModuleID = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "ModuleID", "12")
        'PARA_POID = D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "POID", "")
        'Update 13/10/2010: lấy biến CodeTable từ Registry
...
#End If
    ...
    Private Sub AssignToPublicVariable()
        ...
        gbyUseWorkflow = PARA_gbyUseWorkFlow
    ...
    Private Sub SaveParameter()
        ...
        'D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "DivisionID", "KVQN")
        ...
        D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "Ctrl01", ff) 'PARA_FormID
        D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "Ctrl03", ff) 'PARA_FormIDPermission
        D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "UseWorkFlow", "0")

        D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "ID01", "001") 'PARA_FormIDPermission
        D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "ID07", "D12F3030") 'PARA_FormIDPermission
        D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "POID", "12PO0A000000168") 'PARA_FormIDPermission
        D99C0007.SaveOthersSetting(EXEMODULE, EXECHILD, "ID07", "D12F0000")

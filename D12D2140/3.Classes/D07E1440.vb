'''' Các màn hình của exe con D07E1240

''' <summary>
''' Class D07E0140 dùng để gọi exe D07E0140
''' </summary>
''' <remarks></remarks>
Public Class D07E1440
    Private Const EXEMODULE As String = "D07"
    Private Const EXECHILD As String = "D07E1440"
    ...
    Public ReadOnly Property Output02() As Boolean
        Get
            Return CType(D99C0007.GetOthersSetting(EXEMODULE, EXECHILD, "Output02", "0"), Boolean)
        End Get
    End Property
